...
plot_title = "Combined Tension/Compresssion-Strain Curve with Linear Fit"
x_label = "Strain (%)"
y_label = "Stress (GPa)"

# Output image file name
output_figure = "youngs_modulus_combined_fit.png"
...
# -----------------------------
# 3. Linear Fit
# Model: stress = m * strain + b
# -----------------------------
coeffs = np.polyfit(strain_fit, stress_fit, 1)
m = coeffs[0]          # slope = Young's modulus
...
# -----------------------------
print("=" * 80)
print("LINEAR FIT RESULTS FOR YOUNG'S MODULUS - COMBINED TENSION AND COMPRESSION")
print("=" * 80)
print("Fit equation:")
print("    stress = E * strain + b")
print()
print(f"Slope (Young's modulus, E) = {m:.{print_decimals}f} GPa")
print(f"Intercept (b)              = {b:.{print_decimals}f} GPa")
...
ax.yaxis.set_major_locator(MultipleLocator(1))      # Y ticks every 1
