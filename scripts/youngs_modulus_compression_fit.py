...
# 1. Read data
# -----------------------------
data = pd.read_csv("youngs_compression_data.csv")
...
plot_title = "Compression-Strain Curve with Linear Fit"
x_label = "Strain (%)"
y_label = "Compression (GPa)"

# Output image file name
output_figure = "youngs_modulus_compression_fit.png"
...
# -----------------------------
print("=" * 60)
print("LINEAR FIT RESULTS FOR YOUNG'S MODULUS - COMPRESION")
print("=" * 60)
print("Fit equation:")
