...
# 1. Read data
# -----------------------------
data = pd.read_csv("youngs_tension_data.csv")
...
plot_title = "Tension-Strain Curve with Linear Fit"
x_label = "Strain (%)"
y_label = "Tension (GPa)"

# Output image file name
output_figure = "youngs_modulus_tension_fit.png"
...
# -----------------------------
print("=" * 60)
print("LINEAR FIT RESULTS FOR YOUNG'S MODULUS - TENSION")
print("=" * 60)
print("Fit equation:")
