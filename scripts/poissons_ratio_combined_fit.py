...
plot_title = "Lateral-Linear Strain Curve with Linear Fit"
x_label = "Linear Strain"
y_label = "Lateral Strain"

# Output image file name
output_figure = "poissons_ratio_combined_fit.png"
...
# -----------------------------
print("=" * 60)
print("LINEAR FIT RESULTS FOR POISSON'S RATIO")
print("=" * 60)
print("Fit equation:")
print("    lateral_strain = -K * liinear_strain + b")
print()
