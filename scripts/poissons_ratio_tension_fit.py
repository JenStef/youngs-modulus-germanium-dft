...
# 1. Read data
# -----------------------------
data = pd.read_csv("poissons_tension_data.csv")
...
plot_title = "Lateral-Linear Strain Curve with Linear Fit - Tension"
x_label = "Linear Strain"
y_label = "Lateral Strain"

# Output image file name
output_figure = "poissons_ratio_tension_fit.png"
...
# -----------------------------
print("=" * 60)
print("LINEAR FIT RESULTS FOR POISSON'S RATIO - TENSION")
print("=" * 60)
print("Fit equation:")
